...
if not exist "%CMS_PS%" (
  ...
  set "CMS_BOOTSTRAP_ARGS=-NoProfile -ExecutionPolicy Bypass -File ""%CMS_INSTALLER%"" -Mode AgentVisible -ServerUrl ""%CMS_SERVER_URL%"" -EnrollmentToken ""%CMS_ENROLLMENT_TOKEN%"" -DeviceName ""%CMS_DEVICE_NAME%"""
